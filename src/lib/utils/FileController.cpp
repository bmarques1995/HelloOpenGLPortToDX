...
bool APILearning::FileController::ReadTextFile(std::string_view path, std::string* content)
{
	bool loaded = false;
...
bool APILearning::FileController::WriteTextFile(std::string_view path, std::string content)
{
	bool stored = false;
...
bool APILearning::FileController::ReadBinFile(std::string_view path, std::byte** content)
{
	bool loaded = false;
	std::ifstream fileStream;
	fileStream.exceptions(std::ifstream::badbit | std::ifstream::failbit);
...
bool APILearning::FileController::WriteBinFile(std::string_view path, std::byte* content, size_t dataSize)
{
	bool stored = false;
	std::ofstream fileStream;
	fileStream.exceptions(std::ofstream::badbit);
...
bool APILearning::FileController::FileExists(std::string_view path)
{
	bool loaded = false;
	std::ifstream fileStream;
